    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 pt-24 sm:pt-28">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">
            My Orders
          </h1>
        ...
        {orders.length === 0 ? (
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-8 sm:p-12 text-center border border-blue-200">
            <Package size={48} className="sm:w-16 sm:h-16 mx-auto text-blue-300 mb-4" />
            ...
            <a
              href="/stationery"
              className="inline-block px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-105 font-semibold shadow-lg"
            >
              Start Shopping
            </a>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            {orders.map((order) => (
              <div key={order.id} className="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-200">
                <div className="p-4 sm:p-6">
                  ...
                  {/* Status with Icon */}
                  <div className="flex items-center gap-2 mb-3 p-2 sm:p-3 bg-gradient-to-r from-sky-50 to-blue-50 rounded-lg border border-blue-100">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-blue-600 hover:text-blue-700 font-semibold text-sm w-full justify-center sm:justify-start py-2 hover:bg-blue-50 rounded-lg transition-colors"
                  >
                    ...
                    <div className="mt-4 pt-4 border-t border-blue-100">
                      ...
                      <div className="space-y-3 mb-4">
                        {order.items.map((item, index) => (
                          <div key={index} className="flex gap-2 sm:gap-3 p-2 sm:p-3 bg-gradient-to-r from-sky-50 to-blue-50 rounded-lg border border-blue-100">
                            <img
                              src={item.image}
                              alt={item.name}
                      ...
                      <div className="bg-gradient-to-r from-sky-50 to-blue-50 p-3 sm:p-4 rounded-lg text-xs sm:text-sm text-gray-700 border border-blue-100">
                      ...
                      <div className="mt-4 pt-4 border-t border-blue-100 bg-gradient-to-r from-sky-50 to-blue-50 p-3 rounded-lg">
