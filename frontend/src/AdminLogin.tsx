    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md shadow-sm placeholder-gray-400"
                  placeholder="admin@printnsupply.com"
                />
              </div>
            </div>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>© 2025 PrintNSupply. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
