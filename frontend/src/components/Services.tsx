...
export function Services() {
  return (
    <section className="relative py-16 md:py-24 bg-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-2xl sm:blur-3xl opacity-40 animate-float"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-sky-200 rounded-full mix-blend-multiply filter blur-2xl sm:blur-3xl opacity-40 animate-float animation-delay-2000"></div>
