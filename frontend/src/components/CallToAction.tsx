    ...
    <section className="hidden md:block relative py-24 bg-gradient-to-br from-blue-600 via-indigo-700 to-blue-800 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <Link href="/upload">
            <button className="group relative px-10 py-5 bg-white text-blue-700 rounded-2xl text-lg font-bold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden">
