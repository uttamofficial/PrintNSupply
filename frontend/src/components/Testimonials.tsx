  ...
  return (
    <section className="hidden md:block relative py-24 bg-gradient-to-b from-sky-50 to-blue-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-blue-200 mb-6 shadow-sm">
            <Sparkles className="w-4 h-4 text-blue-600" />
            <span className="text-sm font-semibold text-blue-900">Testimonials</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Card */}
              <div className="relative h-full p-8 bg-white rounded-2xl border border-blue-200 hover:border-blue-300 hover:shadow-xl transition-all duration-500 overflow-hidden">
