...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {/* Sidebar */}
      <div 
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-indigo-700 to-indigo-800 shadow-xl transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col flex-shrink-0`}
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-indigo-600">
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-3 text-xl font-bold text-white">PrintNSupply</span>
            </div>
          </div>
          <button
        ...
        <div className="flex-shrink-0 flex bg-indigo-800 p-4 border-t border-indigo-600">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs font-medium text-indigo-200">Administrator</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="ml-auto flex-shrink-0 bg-indigo-600 p-2 rounded-full text-indigo-200 hover:text-white hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
        ...
        <footer className="bg-white border-t border-gray-200 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm text-gray-500">
              © 2025 PrintNSupply Admin Panel. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
